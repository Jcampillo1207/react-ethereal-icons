  ...
  const cleanedJsxCode = jsxCode
    ...
    .replace(
      ...
      (match, p1, p2, p3) => {
        ...
        return `<${p1}${p2} fill={${colorProp} ? ${colorProp} : '${p3}'}`;
      }
    );
...
generateIcons()
  .then(() => console.log("Ethereal icons generated successfully"))
  .catch((err) => console.error("Error generating ethereal icons:", err));
