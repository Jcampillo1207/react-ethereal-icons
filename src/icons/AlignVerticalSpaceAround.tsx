 ...
 * @description Automatically generated SVG icon component for AlignVerticalSpaceAround.
...
interface AlignVerticalSpaceAroundProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
