 ...
 * @component
 * @name SearchPlus
 * @description Automatically generated SVG icon component for SearchPlus.
...
interface SearchPlusProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
...
const SearchPlus: React.FC<SearchPlusProps> = ({ size = 24, color, strokeWidth = 2, color1, color2, className, ...props }) => (
