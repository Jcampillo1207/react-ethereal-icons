...
/**
 * @component
 * @name AlignVerticalDistributionCenter
 * @description Automatically generated SVG icon component for AlignVerticalDistributionCenter.
...
interface AlignVerticalDistributionCenterProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
