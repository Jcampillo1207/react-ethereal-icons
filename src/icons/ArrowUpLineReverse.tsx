...
/**
 * @component
 * @name ArrowUpLineReverse
 * @description Automatically generated SVG icon component for ArrowUpLineReverse.
...
interface ArrowUpLineReverseProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
