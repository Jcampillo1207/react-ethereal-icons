 ...
 * @component
 * @name Plane1
 * @description Automatically generated SVG icon component for Plane1.
...
interface Plane1Props extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
...
const Plane1: React.FC<Plane1Props> = ({ size = 24, color, strokeWidth = 2, color1, color2, className, ...props }) => (
