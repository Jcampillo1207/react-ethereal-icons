 ...
 * @component
 * @name CircleDashed
 * @description Automatically generated SVG icon component for CircleDashed.
...
interface CircleDashedProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
...
const CircleDashed: React.FC<CircleDashedProps> = ({ size = 24, color, strokeWidth = 2, color1, color2, className, ...props }) => (
