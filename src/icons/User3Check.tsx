 ...
 * @component
 * @name User3Check
 * @description Componente de ícono SVG generado automáticamente para User3Check.
 * @preview https://your-preview-url.com/user3check
