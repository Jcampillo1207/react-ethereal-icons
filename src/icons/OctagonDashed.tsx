 ...
 * @component
 * @name OctagonDashed
 * @description Automatically generated SVG icon component for OctagonDashed.
...
interface OctagonDashedProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
...
const OctagonDashed: React.FC<OctagonDashedProps> = ({ size = 24, color, strokeWidth = 2, color1, color2, className, ...props }) => (
