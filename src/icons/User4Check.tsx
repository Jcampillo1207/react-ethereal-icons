 ...
 * @component
 * @name User4Check
 * @description Componente de ícono SVG generado automáticamente para User4Check.
 * @preview https://your-preview-url.com/user4check
