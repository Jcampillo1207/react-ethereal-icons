 ...
 * @component
 * @name SearchCheck
 * @description Automatically generated SVG icon component for SearchCheck.
...
interface SearchCheckProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
...
const SearchCheck: React.FC<SearchCheckProps> = ({ size = 24, color, strokeWidth = 2, color1, color2, className, ...props }) => (
