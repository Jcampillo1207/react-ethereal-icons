 ...
 * @component
 * @name HalfMoonStar
 * @description Automatically generated SVG icon component for HalfMoonStar.
...
interface HalfMoonStarProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
...
const HalfMoonStar: React.FC<HalfMoonStarProps> = ({ size = 24, color, strokeWidth = 2, color1, color2, className, ...props }) => (
