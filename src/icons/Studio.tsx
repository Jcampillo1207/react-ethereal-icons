 ...
 * @component
 * @name Studio
 * @description Componente de ícono SVG generado automáticamente para Studio.
 * @preview https://your-preview-url.com/studio
...
const Studio: React.FC<StudioProps> = ({ size = 24, color, strokeWidth = 1.5, color1, color2, className, ...props }) => (
