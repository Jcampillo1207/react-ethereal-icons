 ...
 * @component
 * @name Badge1Plus
 * @description Componente de ícono SVG generado automáticamente para Badge1Plus.
 * @preview https://your-preview-url.com/badge1plus
...
const Badge1Plus: React.FC<Badge1PlusProps> = ({ size = 24, color, strokeWidth = 1.5, color1, color2, className, ...props }) => (
