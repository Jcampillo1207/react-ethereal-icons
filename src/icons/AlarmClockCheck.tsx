 ...
 * @description Automatically generated SVG icon component for AlarmClockCheck.
...
interface AlarmClockCheckProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
