 ...
 * @component
 * @name Pool1
 * @description Automatically generated SVG icon component for Pool1.
...
interface Pool1Props extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
...
const Pool1: React.FC<Pool1Props> = ({ size = 24, color, strokeWidth = 2, color1, color2, className, ...props }) => (
