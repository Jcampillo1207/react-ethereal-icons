 ...
 * @description Automatically generated SVG icon component for AlignVerticalSpaceBetween.
...
interface AlignVerticalSpaceBetweenProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
