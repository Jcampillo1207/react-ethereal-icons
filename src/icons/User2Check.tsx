 ...
 * @component
 * @name User2Check
 * @description Componente de ícono SVG generado automáticamente para User2Check.
 * @preview https://your-preview-url.com/user2check
