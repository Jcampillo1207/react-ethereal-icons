...
/**
 * @component
 * @name ArrowBigUpDashed
 * @description Automatically generated SVG icon component for ArrowBigUpDashed.
...
interface ArrowBigUpDashedProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
