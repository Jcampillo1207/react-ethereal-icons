...
/**
 * @component
 * @name CircleChevronUpDashed
 * @description Automatically generated SVG icon component for CircleChevronUpDashed.
...
interface CircleChevronUpDashedProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
