 ...
 * @component
 * @name HomePlus
 * @description Automatically generated SVG icon component for HomePlus.
...
interface HomePlusProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  strokeWidth?: number;
  color1?: string;
